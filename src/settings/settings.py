...
select_button_pos = [
    [[screen_width / 2 + 35, 505], [screen_width / 2 + 235, 505]],
    [[screen_width / 2 + 35, 545], [screen_width / 2 + 235, 545]],
]

select_move_button_pos = [[[10, 505], [205, 505]], [[10, 555], [205, 555]]]

# seleção da continuação da fight
select_cont_fight = [
    [screen_width - 110, screen_height - screen_height / 4.5 + 35],
...
menu_description = {
    "Bokumon": [
        "Check and organize Bokumon that are",
        "traveling with you in your party.",
    ],
    "Bag": [
        "Equipped with pockets for storing items you",
        "bought, received, or found.",
    ],
    "Save": [
        "Save your game with a complete record of",
        "your progress to take a break.",
    ],
