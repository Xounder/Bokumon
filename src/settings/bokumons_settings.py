...
def initial_atrib(name, lvl_diff):
    ...
    boku_stats = [
        randint(
            bokumons_base_stats[name][0] + round(1.5 * boku_lvl_diff),
            bokumons_base_stats[name][0] + round(2.5 * boku_lvl_diff),
        ),
        randint(
            bokumons_base_stats[name][1] + round(1.5 * boku_lvl_diff),
            bokumons_base_stats[name][1] + round(2.5 * boku_lvl_diff),
        ),
        randint(
            bokumons_base_stats[name][2] + round(1.5 * boku_lvl_diff),
            bokumons_base_stats[name][2] + round(2.5 * boku_lvl_diff),
        ),
        randint(
            bokumons_base_stats[name][3] + round(1.5 * boku_lvl_diff),
            bokumons_base_stats[name][3] + round(2.5 * boku_lvl_diff),
        ),
        randint(
            bokumons_base_stats[name][4] + round(boku_lvl_diff / 2),
            bokumons_base_stats[name][4] + boku_lvl_diff,
        ),
    ]
